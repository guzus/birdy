...
`birdy scrape` is the batch collector for tweets, profiles, lists, and searches.
It fills the gap a hosted X tweet scraper covers: mixed URLs, structured
filters, Latest+Top search, and CSV/flat export. Results are deduplicated
before output.
