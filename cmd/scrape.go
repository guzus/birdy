...
func newScrapeCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		GroupID: "birdy",
		Long: `scrape is birdy's batch tweet collector — the local equivalent of a
hosted X tweet scraper. Mix tweet, profile, search, and list URLs with
handles, tweet IDs, and structured filters. Results are deduplicated
before output.
